        ...
        for i, det in enumerate(pred):  # per image
            ...
            if len(det):
                ...
                # 把坐标输入的number中。
                    ...
                    if number__ != 0:
                        print('执行')
                        word = ui.label_word.text()
                        ui.label_word.setText("-"*40 + "\n" + number__ + "\n" + word)
                        # save_txt.save_txt(number__)
                    print("自行完成")
...
if __name__ == '__main__':
    ...
    class Ui_MainWindow(QtWidgets.QWidget):
        ...
        def set_ui(self):
            ...
            self.label_word = QtWidgets.QLabel(self)
            self.label_word.move(10, 500)
            self.label_word.setFixedSize(500, 500)

            self.label_show = QtWidgets.QLabel(self)
            self.label_show.move(10, 100)
            ...
            self.label_show_camera.setGeometry(QtCore.QRect(100, 100, 1000, 800)) #调整窗口上下 宽高
