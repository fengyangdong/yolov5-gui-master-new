...
class Ui_MainWindow(QtWidgets.QWidget):
    ...
    def set_ui(self):
        ...
        self.__layout_data_word = QtWidgets.QVBoxLayout()
        self.button_open_camera = QtWidgets.QPushButton('开始')  # 建立用于打开摄像头的按键
        ...
        self.__layout_main.addLayout(self.__layout_data_word)
    ...
    def button_open_camera_clicked(self):
        ...
        self.button_open_camera.setText('结束')
